			...
			<div class="card"
				...
				<div class="card-body bg-dark">
					...
					<div class="row no-gutters">
						...
						&emsp; <strong style="color: white">Subject Name :~</strong>&nbsp;
						<div class="col-sm-2">
							<input placeholder="Subject Name" style="background-color: white"
								type="text" name="subjectName" class="border"
					...
					<div class="row no-gutters">
						<button type="submit" style="font-size: 13px" name="operation"
							value="<%=SubjectListCtl.OP_NEW%>" class="btn btn-success">
