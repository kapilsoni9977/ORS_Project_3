			...
			<div class="card"
				...
				<div class="card-body bg-dark">
					...
					<%
						...
						System.out.println("................Course List.............." + list);
						if (list.size() == 0) {
					%>
					<table align="center">
						<tr>
					...
					<div class="row no-gutters">
						...
						<i style="color: white"><b>Course :</b></i>&nbsp;
						<%
							List roleList = (List) request.getAttribute("courseList");
						%>

						<div class="col-sm-2"><%=HTMLUtility.getList("course", String.valueOf(dto.getId()), roleList)%>
						</div>
					...
					<div class="row no-gutters">
						<button type="submit" style="font-size: 13px" name="operation"
							value="<%=CourseListCtl.OP_NEW%>" class="btn btn-success">
					...
					<table class="table table-light table-striped" border="2">
						...
						<tbody>
							<tr align="center">
								...
								<td class="text"><a href="CourseCtl?id=<%=dto.getId()%>"
