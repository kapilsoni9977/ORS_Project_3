...
public class FacultyCtl extends BaseCtl {
	...
	protected void preload(HttpServletRequest request) {
		...
		try {
			List collegeList = collegeModel.list(0, 0);
	...
	protected BaseDTO populateDTO(HttpServletRequest request) {
		...
		dto.setDob(DataUtility.getDate(request.getParameter("joiningDate")));
		...
		System.out.println("------------------Kapil----------------------"+request.getParameter("login"));
